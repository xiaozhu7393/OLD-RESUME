...
\section{专业技能}
\subsection{开发}
\cvcomputer{框架}{Django, jQuery,jQuery Mobile,BootStrap,Laravel}
           {Web}{HTML,DIV+CSS, Nodejs,AJAX,RESTful,}
\cvcomputer{语言}{C,Python, JavaScript}
           {数据库}{MySQL, MongoDB,}
...
\begin{tightitemize}
 \item 使用jQuery+Timerliner完成的个人网页简历 {\httplink{about.phodal.com}}
 \item 使用Laravel做的CMS {\httplink{www.xianuniversity.com}}
